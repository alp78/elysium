...
>
> RCSI stores row versions in TempDB. Monitor TempDB growth after enabling. On high-throughput pipelines, version store can grow significantly. See [memory-and-buffer-pool](https://alp78.github.io/elysium/04-SQL-Server/01-Server-Operations/memory-and-buffer-pool) for TempDB sizing.
