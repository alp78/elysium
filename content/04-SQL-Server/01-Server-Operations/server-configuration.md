...
Database-scoped settings such as recovery model, compatibility level, Query Store, and row-versioned isolation live in [[database-creation-and-file-layout]]. Table-shape guardrails such as clustered-vs-heap decisions live in [[schemas-tables-and-constraints]].
...
Database-level defaults such as recovery model, compatibility level, Query Store, row-versioning, and heap-vs-clustered decisions are covered in [[database-creation-and-file-layout]] and [[schemas-tables-and-constraints]].
