...
- [[backup-types-and-strategy]] for the SQL-aware backup chain that underpins any storage-cost discussion
- [[server-configuration]] for the instance settings that influence backup behavior and log growth
- [[memory-and-buffer-pool]] for the live SQL Server memory signals that should inform right-sizing
