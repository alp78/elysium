...
- [[essential-dba-queries]] for the actual diagnostic queries to run once connected
- [[backup-types-and-strategy]] for one-shot backup automation patterns that typically use `sqlcmd`
- [[restore-and-recovery]] for scripted restore operations where `sqlcmd` is often the delivery vehicle
