...
Start here when users report slowness or pipeline runs are taking longer than usual. The first step is always [[wait-stats-analysis|wait statistics]].
...
- [[blocking-and-locking]] — diagnosing and resolving LCK_M_* waits
- [[deadlock-detection-and-prevention]] — error 1205 handling, retry logic, prevention patterns
- [[index-types-and-strategy]] — comprehensive index selection and creation guide
- [[index-maintenance]] — fragmentation analysis and scheduled rebuild/reorganize
- [[memory-and-buffer-pool]] — PLE, buffer cache hit ratio, and memory clerk analysis
- [[backup-types-and-strategy]] — log backup strategy to prevent .ldf from filling up
