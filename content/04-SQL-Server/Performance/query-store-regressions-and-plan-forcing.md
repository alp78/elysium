---
title: "Query Store Regressions and Plan Forcing"
...
This page is not the place to learn how to read an execution plan from scratch. That material now lives in [[execution-plans]]. This page starts later in the workflow: Query Store is already enabled, a query has more than one plan or its runtime has drifted, and the job is to decide whether to observe, force, hint, or fix the root cause.
