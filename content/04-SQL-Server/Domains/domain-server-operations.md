...
>
> - [[users-logins-roles-permissions#Core Definitions|Core definitions: principal, securable, permission, login, user, role, schema]]
> - [[users-logins-roles-permissions#Scenario Patterns|Scenario patterns for admins, engineers, pipelines, BI, and vendors]]
> - [[users-logins-roles-permissions#Auditing and Inventory Queries|Auditing and inventory queries]]
> - [[users-logins-roles-permissions#Additional Security Features|Orphaned users, application roles, RLS, dynamic data masking]]
