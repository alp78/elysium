...
- **Data mesh governance**: See [[data-mesh-architecture]] — in a domain-oriented ownership model, the catalog is how one domain publishes its data products for other domains to discover.
...
See [[service-accounts-and-iam]] for the principle of least privilege approach — pipelines that only report lineage need `roles/datalineage.producer`, not full admin.
...
See [[airflow-core-concepts]] for the full pattern of using Airflow callbacks for observability.
...
See [[dbt-transformation-layer]] for the full dbt operational model this integrates with.
...
- [[data-warehouse-architecture]] — BigQuery design patterns that the lineage layer governs
- [[data-lake-architecture]] — GCS organization that Dataplex discovery crawls
- [[data-mesh-architecture]] — Domain-oriented data products that the catalog makes discoverable
...
- [[service-accounts-and-iam]] — IAM roles for Dataplex, Lineage API, and Data Catalog
- [[querying-and-cost-optimization]] — Using catalog tags for cost attribution and slot optimization
- [[dbt-transformation-layer]] — dbt manifest lineage integration and model tagging
- [[airflow-core-concepts]] — Airflow OpenLineage provider and callback patterns for lineage reporting
