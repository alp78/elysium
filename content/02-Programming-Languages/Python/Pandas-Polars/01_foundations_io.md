...
### 1.1 Creating a Series from a Python list
...
### 1.2 Creating a Series from a NumPy array
...
### 1.3 Custom index (Pandas) vs named-only (Polars)
...
### 1.4 Data types — inference and casting
...
### 2.1 Creating a DataFrame from a dict
...
### 2.2 Creating a DataFrame from a list of dicts (records)
...
### 2.4 Shape, height, width, column names
...
### 3.2 Polars — no index, use columns instead
...
### 3.3 Gotcha — index alignment in Pandas
...
### 3.4 Pandas MultiIndex vs Polars grouped columns
...
### 4.2 Inspecting types on real data
...
df_pd["volume"] = df_pd["volume"].astype("float64")
...
### 4.4 Gotcha — Pandas `object` vs `string` dtype
...
---
## 5 — Loading Real Data from Multiple Formats
...
# Trying via schema
try:
    df_dup = pl.from_records([(1, 2)], schema=["x", "x"])
    display(df_dup)
except Exception as e:
...
### 7.4 Gotcha — Pandas `.values` vs `.to_numpy()` vs `.to_list()`
...
<small>shape: (20, 3)</small><table border="1" class="dataframe"><thead><tr><th>Feature</th><th>Pandas</th><th>Polars</th></tr><tr><td>str</td><td>str</td><td>str</td></tr></thead><tbody><tr><td>&quot;1-D data structure&quot;</td><td>&quot;pd.Series (indexed)&quot;</td><td>&quot;pl.Series (named, no index)&quot;</td></tr><tr><td>&quot;2-D data structure&quot;</td><td>&quot;pd.DataFrame (indexed)&quot;</td><td>&quot;pl.DataFrame (no index)&quot;</td></tr><tr><td>&quot;Row index&quot;</td><td>&quot;Yes — RangeIndex, named, Multi&quot;</td><td>&quot;No — all data lives in columns&quot;</td></tr><tr><td>&quot;Missing values&quot;</td><td>&quot;NaN (float) or pd.NA&quot;</td><td>&quot;null (Arrow bitmask)&quot;</td></tr><tr><td>&quot;Default int type&quot;</td><td>&quot;int64&quot;</td><td>&quot;Int64&quot;</td></tr><tr><td>&hellip;</td><td>&hellip;</td><td>&hellip;</td></tr><tr><td>&quot;Shape attribute&quot;</td><td>&quot;.shape → (rows, cols)&quot;</td><td>&quot;.shape → (rows, cols)&quot;</td></tr><tr><td>&quot;Height / width attrs&quot;</td><td>&quot;No&quot;</td><td>&quot;Yes — .height, .width&quot;</td></tr><tr><td>&quot;Null counting&quot;</td><td>&quot;df.isnull().sum()&quot;</td><td>&quot;df.null_count()&quot;</td></tr><tr><td>&quot;Memory estimation&quot;</td><td>&quot;df.memory_usage(deep=True)&quot;</td><td>&quot;df.estimated_size()&quot;</td></tr><tr><td>&quot;Type casting&quot;</td><td>&quot;.astype() / pd.to_datetime()&quot;</td><td>&quot;.cast() / .str.to_date()&quot;</td></tr></tbody></table></div>
...
for stem in stems:
    ...
    for ext in ["csv", "json", "parquet"]:
        ...
        row[ext + "_KB"] = round(p.stat().st_size / 1024, 1) if p.exists() else None
    rows.append(row)
...
```
    ...
    C:\Users\aperi\AppData\Local\Temp\ipykernel_4628\3125614686.py:2: DeprecationWarning: the argument `dtypes` for `read_csv` is deprecated. It was renamed to `schema_overrides` in version 0.20.31.
      df_pl_ohlcv = pl.read_csv(
...
```
    ...
    Loading all CSV files with Pandas...
      ...
      eurostoxx50_ohlcv              -> (66355, 12)  (0.034s)
      ...
      stoxxusa50_ohlcv               -> (65100, 12)  (0.034s)
      trading_calendar               -> (29335, 11)  (0.011s)
...
## 8 - Lazy Scanning vs Eager Reading
...
display(comp_df.style.set_properties(**{"text-align": "left"}).hide(axis="index"))
```
...
<style type="text/css">
#T_6a391_row0_col0, #T_6a391_row0_col1, #T_6a391_row0_col2, #T_6a391_row0_col3, #T_6a391_row1_col0, #T_6a391_row1_col1, #T_6a391_row1_col2, #T_6a391_row1_col3, #T_6a391_row2_col0, #T_6a391_row2_col1, #T_6a391_row2_col2, #T_6a391_row2_col3, #T_6a391_row3_col0, #T_6a391_row3_col1, #T_6a391_row3_col2, #T_6a391_row3_col3, #T_6a391_row4_col0, #T_6a391_row4_col1, #T_6a391_row4_col2, #T_6a391_row4_col3, #T_6a391_row5_col0, #T_6a391_row5_col1, #T_6a391_row5_col2, #T_6a391_row5_col3, #T_6a391_row6_col0, #T_6a391_row6_col1, #T_6a391_row6_col2, #T_6a391_row6_col3, #T_6a391_row7_col0, #T_6a391_row7_col1, #T_6a391_row7_col2, #T_6a391_row7_col3, #T_6a391_row8_col0, #T_6a391_row8_col1, #T_6a391_row8_col2, #T_6a391_row8_col3, #T_6a391_row9_col0, #T_6a391_row9_col1, #T_6a391_row9_col2, #T_6a391_row9_col3, #T_6a391_row10_col0, #T_6a391_row10_col1, #T_6a391_row10_col2, #T_6a391_row10_col3, #T_6a391_row11_col0, #T_6a391_row11_col1, #T_6a391_row11_col2, #T_6a391_row11_col3, #T_6a391_row12_col0, #T_6a391_row12_col1, #T_6a391_row12_col2, #T_6a391_row12_col3, #T_6a391_row13_col0, #T_6a391_row13_col1, #T_6a391_row13_col2, #T_6a391_row13_col3, #T_6a391_row14_col0, #T_6a391_row14_col1, #T_6a391_row14_col2, #T_6a391_row14_col3 {
  text-align: left;
}
</style>
<table id="T_6a391">
  <thead>
    <tr>
      <th id="T_6a391_level0_col0" class="col_heading level0 col0" >Operation</th>
      <th id="T_6a391_level0_col1" class="col_heading level0 col1" >Pandas</th>
      <th id="T_6a391_level0_col2" class="col_heading level0 col2" >Polars</th>
      <th id="T_6a391_level0_col3" class="col_heading level0 col3" >Notes</th>
    </tr>
  </thead>
  <tbody>
    <tr>
      <td id="T_6a391_row0_col0" class="data row0 col0" >Read CSV</td>
      <td id="T_6a391_row0_col1" class="data row0 col1" >pd.read_csv()</td>
      <td id="T_6a391_row0_col2" class="data row0 col2" >pl.read_csv()</td>
      <td id="T_6a391_row0_col3" class="data row0 col3" >Both excellent</td>
    </tr>
    <tr>
      <td id="T_6a391_row1_col0" class="data row1 col0" >Read JSON</td>
      <td id="T_6a391_row1_col1" class="data row1 col1" >pd.read_json()</td>
      <td id="T_6a391_row1_col2" class="data row1 col2" >pl.read_json()</td>
      <td id="T_6a391_row1_col3" class="data row1 col3" >Polars stricter on schema</td>
    </tr>
    <tr>
      <td id="T_6a391_row2_col0" class="data row2 col0" >Read Parquet</td>
      <td id="T_6a391_row2_col1" class="data row2 col1" >pd.read_parquet()</td>
      <td id="T_6a391_row2_col2" class="data row2 col2" >pl.read_parquet()</td>
      <td id="T_6a391_row2_col3" class="data row2 col3" >Both use Arrow under the hood</td>
    </tr>
    <tr>
      <td id="T_6a391_row3_col0" class="data row3 col0" >Lazy CSV</td>
      <td id="T_6a391_row3_col1" class="data row3 col1" >N/A (use chunksize)</td>
      <td id="T_6a391_row3_col2" class="data row3 col2" >pl.scan_csv()</td>
      <td id="T_6a391_row3_col3" class="data row3 col3" >Polars only</td>
    </tr>
    <tr>
      <td id="T_6a391_row4_col0" class="data row4 col0" >Lazy NDJSON</td>
      <td id="T_6a391_row4_col1" class="data row4 col1" >N/A</td>
      <td id="T_6a391_row4_col2" class="data row4 col2" >pl.scan_ndjson()</td>
      <td id="T_6a391_row4_col3" class="data row4 col3" >Polars only; needs NDJSON format</td>
    </tr>
    <tr>
      <td id="T_6a391_row5_col0" class="data row5 col0" >Lazy Parquet</td>
      <td id="T_6a391_row5_col1" class="data row5 col1" >N/A</td>
      <td id="T_6a391_row5_col2" class="data row5 col2" >pl.scan_parquet()</td>
      <td id="T_6a391_row5_col3" class="data row5 col3" >Polars only; best lazy format</td>
    </tr>
    <tr>
      <td id="T_6a391_row6_col0" class="data row6 col0" >Write CSV</td>
      <td id="T_6a391_row6_col1" class="data row6 col1" >.to_csv()</td>
      <td id="T_6a391_row6_col2" class="data row6 col2" >.write_csv()</td>
      <td id="T_6a391_row6_col3" class="data row6 col3" >Pandas writes index by default</td>
    </tr>
    <tr>
      <td id="T_6a391_row7_col0" class="data row7 col0" >Write JSON</td>
      <td id="T_6a391_row7_col1" class="data row7 col1" >.to_json()</td>
      <td id="T_6a391_row7_col2" class="data row7 col2" >.write_json()</td>
      <td id="T_6a391_row7_col3" class="data row7 col3" >Different default orientations</td>
    </tr>
    <tr>
      <td id="T_6a391_row8_col0" class="data row8 col0" >Write Parquet</td>
      <td id="T_6a391_row8_col1" class="data row8 col1" >.to_parquet()</td>
      <td id="T_6a391_row8_col2" class="data row8 col2" >.write_parquet()</td>
      <td id="T_6a391_row8_col3" class="data row8 col3" >Both produce valid Parquet</td>
    </tr>
    <tr>
      <td id="T_6a391_row9_col0" class="data row9 col0" >dtype override</td>
      <td id="T_6a391_row9_col1" class="data row9 col1" >dtype={...}</td>
      <td id="T_6a391_row9_col2" class="data row9 col2" >dtypes={...}</td>
      <td id="T_6a391_row9_col3" class="data row9 col3" >Param name differs</td>
    </tr>
    <tr>
      <td id="T_6a391_row10_col0" class="data row10 col0" >Schema override</td>
      <td id="T_6a391_row10_col1" class="data row10 col1" >dtype={...}</td>
      <td id="T_6a391_row10_col2" class="data row10 col2" >schema_overrides={...}</td>
      <td id="T_6a391_row10_col3" class="data row10 col3" >Polars has dedicated param</td>
    </tr>
    <tr>
      <td id="T_6a391_row11_col0" class="data row11 col0" >Null values</td>
      <td id="T_6a391_row11_col1" class="data row11 col1" >na_values=[...]</td>
      <td id="T_6a391_row11_col2" class="data row11 col2" >null_values=[...]</td>
      <td id="T_6a391_row11_col3" class="data row11 col3" >Param name differs</td>
    </tr>
    <tr>
      <td id="T_6a391_row12_col0" class="data row12 col0" >Separator</td>
      <td id="T_6a391_row12_col1" class="data row12 col1" >sep=','</td>
      <td id="T_6a391_row12_col2" class="data row12 col2" >separator=','</td>
      <td id="T_6a391_row12_col3" class="data row12 col3" >Param name differs</td>
    </tr>
    <tr>
      <td id="T_6a391_row13_col0" class="data row13 col0" >Column projection</td>
      <td id="T_6a391_row13_col1" class="data row13 col1" >usecols=[...]</td>
      <td id="T_6a391_row13_col2" class="data row13 col2" >columns=[...]</td>
      <td id="T_6a391_row13_col3" class="data row13 col3" >Parquet: both support this</td>
    </tr>
    <tr>
      <td id="T_6a391_row14_col0" class="data row14 col0" >Predicate pushdown</td>
      <td id="T_6a391_row14_col1" class="data row14 col1" >N/A</td>
      <td id="T_6a391_row14_col2" class="data row14 col2" >LazyFrame.filter()</td>
      <td id="T_6a391_row14_col3" class="data row14 col3" >Polars only; major advantage</td>
    </tr>
  </tbody>
</table>
