...
description: "C# basics reference with executable examples and cell outputs — covers variables, data types, type conversion, operators, and console I/O. See [[01_py_basics]] for the Python equivalent."
related:
