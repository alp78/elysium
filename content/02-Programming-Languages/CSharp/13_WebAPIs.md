...
tags: [reference, programming-languages, csharp, dotnet, web-apis]
...
description: "C# web and APIs reference with executable examples and cell outputs — covers HttpClient, ASP.NET Core minimal APIs, controllers, middleware, and authentication. See [[13_WebAPIs - Python]] for the Python equivalent."
related:
  - "[[13_WebAPIs - Python]]"
created: 2026-03-22
updated: 2026-03-22
