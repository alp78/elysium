...
> [!warning] File.WriteAllText / ReadAllText — one-shot file operations
...
> [!warning] Manual CSV write and read — string.Split for controlled data
...
> [!warning] JSON setup — shared options and type declarations
...
> [!warning] YAML format — human-friendly configuration with comments and anchors
...
> [!warning] Stream hierarchy — all .NET I/O flows through streams
...
> [!warning] Async file I/O — non-blocking operations for high-throughput services
...
> [!warning] JSON Source Generators — compile-time serialization for max performance
...
> [!warning] MemoryMappedFile — OS-paged random access for huge files
...
> [!warning] System.IO.Pipelines — high-performance buffered I/O for streaming
...
> [!warning] Zero-allocation CSV parsing with ReadOnlySpan<char>
...
> [!warning] Character encoding — UTF-8, ASCII, Unicode conversion
