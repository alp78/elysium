...
description: "C# web and APIs reference with executable examples and cell outputs — covers HttpClient, ASP.NET Core minimal APIs, controllers, middleware, and authentication. See [15_py_webapis](/02-Programming-Languages/Python/15_py_webapis) for the Python equivalent."
related:
