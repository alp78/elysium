...
description: "C# database reference with executable examples and cell outputs — covers Entity Framework Core, Dapper, raw ADO.NET, migrations, and connection string patterns. See [[14_Database - Python]] for the Python equivalent."
related:
  - "[[14_Database - Python]]"
created: 2026-03-22
updated: 2026-03-22
