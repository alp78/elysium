...
function loadDotnetInteractiveApi() {
    probeAddresses(["http://2a02:8308:718a:f200::655c:2048/","http://2a02:8308:718a:f200:8bd4:d06d:33ed:be05:2048/","http://2a02:8308:718a:f200:1c6:667b:8553:ffbc:2048/","http://fe80::3212:d8da:d32d:4723%15:2048/","http://192.168.0.110:2048/","http://::1:2048/","http://127.0.0.1:2048/","http://fe80::287b:79f1:afc4:90fa%45:2048/","http://172.25.64.1:2048/"])
        .then((root) => {
        // use probing to find host url and api resources
        // load interactive helpers and language services
        let dotnetInteractiveRequire = require.config({
        context: '34852.Microsoft.DotNet.Interactive.Http.HttpPort',
                paths:
            {
