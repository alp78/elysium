...
> [!warning] TPL Dataflow — TransformBlock and ActionBlock for pipeline stages
...
> [!warning] Parallel fetch with SemaphoreSlim rate limiting
...
> [!warning] Process — spawn external programs and capture output
