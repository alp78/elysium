...
description: "Index for the Programming Languages section — paired Python and C# references covering 22 topics from basics to security operations, each with executable examples and cell outputs."
related:
  - "[[index|Elysium]]"
...
Paired Python and C# references covering 22 topics. Each note was converted from an executed Jupyter notebook with cell outputs preserved — you see both the code and its result. Every Python topic has a C# counterpart covering the same concepts in that language.
...
| 22 | Data Transfer (GCS, SQL Server, BigQuery benchmarks) | [[22_py_data_transfer|Python]] | [[22_cs_data_transfer|C#]] |
