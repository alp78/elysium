---
title: "10 - Migration, Idempotency and Backfills"
...
In financial data, processing a record twice is as bad as not processing it at all. A dividend reinvested twice inflates the total return index. A [corporate action](https://alp78.github.io/elysium/17-Financial-Domain/Market-Analysis/index-maintenance-and-corporate-actions) applied twice reverses itself (a 1:4 split applied twice becomes a 1:16 split).
