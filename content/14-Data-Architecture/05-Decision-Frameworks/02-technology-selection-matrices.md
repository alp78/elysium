---
title: "02 - Technology Selection Matrices"
...
See [backup-types-and-strategy](https://alp78.github.io/elysium/04-Databases/01-SQL-Server/01-Server-Operations/backup-types-and-strategy) for SQL Server backup patterns. See [querying-and-cost-optimization](https://alp78.github.io/elysium/06-GCP/BigQuery/querying-and-cost-optimization) for BigQuery cost control.
...
| Encrypt data at rest (SQL Server) | **TDE** | Transparent Data Encryption. See [tde-encryption](https://alp78.github.io/elysium/04-Databases/01-SQL-Server/01-Server-Operations/tde-encryption) |
...
| CI/CD integration | **GitHub Actions: plan on PR, apply on merge** | See [github-actions-ci-cd](https://alp78.github.io/elysium/10-CICD/GitHub-Actions/github-actions-ci-cd) for workflow patterns |
...
| CI/CD | **Buy** | GitHub Actions | CI/CD is infrastructure, not differentiation. See [github-actions-ci-cd](https://alp78.github.io/elysium/10-CICD/GitHub-Actions/github-actions-ci-cd) |
...
| Cost anomaly detection | **GCP Billing alerts** + **Cloud Monitoring** | Catch runaway queries or forgotten VMs. See [finops-cost-optimization](https://alp78.github.io/elysium/04-Databases/01-SQL-Server/01-Server-Operations/finops-cost-optimization) |
...
| Cloud Run services/jobs | **GitHub Actions → `gcloud run deploy`** | Build Docker image, push to Artifact Registry, deploy. See [github-actions-ci-cd](https://alp78.github.io/elysium/10-CICD/GitHub-Actions/github-actions-ci-cd) |
...
| ...manage SQL Server backups | T-SQL + PowerShell | [backup-types-and-strategy](https://alp78.github.io/elysium/04-Databases/01-SQL-Server/01-Server-Operations/backup-types-and-strategy) |
| ...set up CI/CD for a pipeline | GitHub Actions | [github-actions-ci-cd](https://alp78.github.io/elysium/10-CICD/GitHub-Actions/github-actions-ci-cd) |
| ...encrypt data at rest | TDE (SQL Server) or GCS encryption | [tde-encryption](https://alp78.github.io/elysium/04-Databases/01-SQL-Server/01-Server-Operations/tde-encryption) |
...
| ...debug slow SQL Server queries | Wait stats + execution plans | [wait-stats-analysis](https://alp78.github.io/elysium/04-Databases/01-SQL-Server/03-Query-Writing-and-Optimization/wait-stats-analysis) |
...
- [github-actions-ci-cd](https://alp78.github.io/elysium/10-CICD/GitHub-Actions/github-actions-ci-cd) — CI/CD patterns
...
- [finops-cost-optimization](https://alp78.github.io/elysium/04-Databases/01-SQL-Server/01-Server-Operations/finops-cost-optimization) — cost management
