...
> If the person who built the pipeline is unavailable (vacation, sick, departed), can the rest of the team operate, debug, and deploy changes to the pipeline? If not, the automation is incomplete. See also: [[five-pillars-of-data-engineering|Operability (Pillar 5)]].
...
## The Anti-Patterns — What These Rules Prevent
...
- [[five-pillars-of-data-engineering]] — The structural framework (reliability, observability, efficiency, security, operability) that these rules reinforce
- [[idempotent-pipeline-design]] — The practical implementation of Rule 3's emphasis on safe re-execution
