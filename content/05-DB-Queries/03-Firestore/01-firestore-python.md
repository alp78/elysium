...
### Python | Firestore SDK | verify connection — list collections
...
### Python | Firestore SDK | list all documents in a collection
...
### Python | Firestore SDK | get multiple documents by ID
...
### Python | Firestore SDK | range filter with ordering
...
### Python | Firestore SDK | compound filters (AND)
...
### Python | Firestore SDK | IN and NOT-IN filters
...
### Python | Firestore SDK | array contains
...
### Python | Firestore SDK | array contains any
...
### Python | Firestore SDK | ordering and limiting
...
### Python | Firestore SDK | read nested maps from documents
...
### Python | Firestore SDK | query within a subcollection
...
> - **Hot counters → sharded writes.** Maintain N shard documents (`counters/hits_0` … `counters/hits_9`), write to a randomly chosen shard, and sum all shards at read time. For per-symbol pipelines, write to separate documents per symbol.
...
### Python | Firestore SDK | update — partial modifications
...
### Python | Firestore SDK | delete a document
...
### Python | Firestore SDK | transaction — conditional read-modify-write
...
### Python | Firestore SDK | SUM and AVG — server-side
...
### Python | Firestore SDK | collection group — filter by date
...
### Python | Firestore SDK | list subcollections
...
### Python | Firestore SDK | find stale documents
...
### Python | Firestore SDK | read application config
