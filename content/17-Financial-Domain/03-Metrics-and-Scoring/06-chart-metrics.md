...
> For additional risk metrics beyond what the dashboard charts display, see [risk-and-volatility-metrics](https://alp78.github.io/elysium/17-Financial-Domain/Market-Analysis/risk-and-volatility-metrics) (Sortino ratio, Calmar ratio, VaR).

## Related

- [index-snapshot-metrics](https://alp78.github.io/elysium/17-Financial-Domain/Metrics-and-Scoring/index-snapshot-metrics) for the snapshot panel that accompanies these charts
- [risk-and-volatility-metrics](https://alp78.github.io/elysium/17-Financial-Domain/Market-Analysis/risk-and-volatility-metrics) for extended risk measures
- [scoring-methodology](https://alp78.github.io/elysium/17-Financial-Domain/Metrics-and-Scoring/scoring-methodology) for the mathematical foundations
- [data-sources-and-refresh](https://alp78.github.io/elysium/17-Financial-Domain/Metrics-and-Scoring/data-sources-and-refresh) for price data sourcing
