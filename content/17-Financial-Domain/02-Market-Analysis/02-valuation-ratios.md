...
Measures the cash return a company generates relative to its market capitalization. More reliable than earnings yield because [free cash flow](https://alp78.github.io/elysium/17-Financial-Domain/Metrics-and-Scoring/quarterly-signal-scores) is harder to manipulate than accounting earnings.
...
| Negative | Burning cash — check [health warnings](https://alp78.github.io/elysium/17-Financial-Domain/Metrics-and-Scoring/quarterly-signal-scores) |
...
The [dashboard](https://alp78.github.io/elysium/17-Financial-Domain/Metrics-and-Scoring/index-snapshot-metrics) tracks these cap-weighted index-level valuation metrics daily:
...
The [Relative Value Score](https://alp78.github.io/elysium/17-Financial-Domain/Metrics-and-Scoring/daily-signal-scores) uses inverted z-scores of Forward P/E, Price/Book, EV/EBITDA, and Dividend Yield to rank constituents by relative cheapness within their index.

## Related

- [index-snapshot-metrics](https://alp78.github.io/elysium/17-Financial-Domain/Metrics-and-Scoring/index-snapshot-metrics) — Dashboard-level P/E, P/B, dividend yield
- [daily-signal-scores](https://alp78.github.io/elysium/17-Financial-Domain/Metrics-and-Scoring/daily-signal-scores) — Relative value composite score using valuation z-scores
- [quarterly-signal-scores](https://alp78.github.io/elysium/17-Financial-Domain/Metrics-and-Scoring/quarterly-signal-scores) — Quality/moat score using fundamental ratios
- [technical-indicators](https://alp78.github.io/elysium/17-Financial-Domain/Market-Analysis/technical-indicators) — Price-based momentum and trend indicators
- [scoring-methodology](https://alp78.github.io/elysium/17-Financial-Domain/Metrics-and-Scoring/scoring-methodology) — Z-score calculation methodology
