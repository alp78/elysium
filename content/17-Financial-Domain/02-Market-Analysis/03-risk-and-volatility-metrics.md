---
title: "03 - Risk and Volatility Metrics"
type: reference
...
Risk and volatility metrics quantify the uncertainty and potential downside of equity index investments. These complement the [dashboard's volatility chart](https://alp78.github.io/elysium/17-Financial-Domain/Metrics-and-Scoring/chart-metrics) and [30d volatility](https://alp78.github.io/elysium/17-Financial-Domain/Metrics-and-Scoring/index-snapshot-metrics) with deeper risk analysis dimensions.
...
The [dashboard drawdown chart](https://alp78.github.io/elysium/17-Financial-Domain/Metrics-and-Scoring/chart-metrics) displays this metric in real-time:
...
An improvement over the [Sharpe ratio](https://alp78.github.io/elysium/17-Financial-Domain/Metrics-and-Scoring/chart-metrics) that only penalizes downside volatility — upside volatility is not considered risk.
...
The [dashboard](https://alp78.github.io/elysium/17-Financial-Domain/Metrics-and-Scoring/chart-metrics) displays two volatility visualizations:
...
- [chart-metrics](https://alp78.github.io/elysium/17-Financial-Domain/Metrics-and-Scoring/chart-metrics) — Dashboard volatility and Sharpe ratio visualizations
- [index-snapshot-metrics](https://alp78.github.io/elysium/17-Financial-Domain/Metrics-and-Scoring/index-snapshot-metrics) — 30d volatility and index-level risk metrics
- [daily-signal-scores](https://alp78.github.io/elysium/17-Financial-Domain/Metrics-and-Scoring/daily-signal-scores) — Momentum z-scores related to trend strength
- [technical-indicators](https://alp78.github.io/elysium/17-Financial-Domain/Market-Analysis/technical-indicators) — RSI, MACD, and other technical momentum indicators
- [valuation-ratios](https://alp78.github.io/elysium/17-Financial-Domain/Market-Analysis/valuation-ratios) — Fundamental valuation metrics
