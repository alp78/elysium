...
- [[open-table-formats]] — deep technical dive into Iceberg, Delta Lake, Hudi metadata models
- [[medallion-architecture]] — bronze/silver/gold organizational pattern within a lakehouse
- [[dbt-transformation-layer]] — SQL transformation on lakehouse tables
