...
tags: [reference, data-formats, etl, concept, python]
...
related: [json-and-csv-processing, parquet-files, date-and-time-handling, sql-python-csharp-transforms]
created: 2026-03-22
updated: 2026-03-22
status: complete
---
...
> - **Data lake and analytics** → [[parquet-files|Parquet]] (columnar, compressed, schema embedded)
...
- Best for: [[json-and-csv-processing|REST APIs, configuration files, debugging pipeline output]]
