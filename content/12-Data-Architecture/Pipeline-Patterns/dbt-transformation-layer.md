...
dbt snapshots implement [[slowly-changing-dimensions|Slowly Changing Dimensions (SCD) Type 2]] automatically — tracking historical changes to dimension tables by adding `dbt_valid_from` and `dbt_valid_to` columns.
