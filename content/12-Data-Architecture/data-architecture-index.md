...
technology: []
tags: [index, data-architecture, data-warehouse, data-lake, lakehouse, data-mesh, streaming, medallion]
...
1. [[five-pillars-of-data-engineering]] — The mindset framework
2. [[dimensional-modeling]] — Star schema, fact/dimension tables, SCD types (start here for modeling)
3. [[data-modeling-patterns]] — All modeling approaches: 3NF, Data Vault, OBT, time-series, graph
4. [[data-warehouse-architecture]] — Classical foundations (Kimball vs Inmon, cloud warehouses)
5. [[data-lake-architecture]] — Scale-out storage with schema-on-read
6. [[lakehouse-architecture]] — The modern convergence (Delta Lake, Iceberg)
7. [[medallion-architecture]] — Bronze/Silver/Gold layering pattern
8. [[context-and-metadata-architecture]] — Preserving context through every pipeline stage
9. [[idempotent-pipeline-design]] — The most critical pipeline reliability pattern
10. [[dbt-transformation-layer]] — SQL-first transformation tooling
11. [[streaming-architecture]] — Real-time and event-driven patterns
12. [[data-mesh-architecture]] — Organizational architecture for large teams
13. [[open-table-formats]] — Deep dive into Delta/Iceberg/Hudi internals
