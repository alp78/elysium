...
>
> **Consumption layer**
> - covers dashboard-oriented queries and the pipeline flow from [silver](https://alp78.github.io/elysium/04-Databases/01-SQL-Server/04-Applied-SQL-Server-for-Data-Pipelines/silver-transforms) through Python plus pandas into gold tables and finally into the Blazor dashboard
>
...
Because OHLCV tables are created dynamically per index (see [bronze DDL](https://alp78.github.io/elysium/04-Databases/01-SQL-Server/04-Applied-SQL-Server-for-Data-Pipelines/bronze-layer-loading#dynamic-ohlcv-tables)), the transform must verify the table exists before querying it. If a new index was configured but `setup_index.py` has not yet run, this check prevents a runtime error.
...
- [silver-transforms](https://alp78.github.io/elysium/04-Databases/01-SQL-Server/04-Applied-SQL-Server-for-Data-Pipelines/silver-transforms) — upstream: cleaned data that feeds all gold transforms
- [bronze-layer-loading](https://alp78.github.io/elysium/04-Databases/01-SQL-Server/04-Applied-SQL-Server-for-Data-Pipelines/bronze-layer-loading) — raw data layer and DDL conventions
