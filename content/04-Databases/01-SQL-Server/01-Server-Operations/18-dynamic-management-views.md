...
**Used in:** [essential-dba-queries](https://alp78.github.io/elysium/04-Databases/01-SQL-Server/01-Server-Operations/06-essential-dba-queries) · [restore-and-recovery](https://alp78.github.io/elysium/04-Databases/01-SQL-Server/01-Server-Operations/08-restore-and-recovery) · [sql-server-problems](https://alp78.github.io/elysium/04-Databases/01-SQL-Server/01-Server-Operations/14-sql-server-problems) · [troubleshooting-flowcharts](https://alp78.github.io/elysium/04-Databases/01-SQL-Server/01-Server-Operations/15-troubleshooting-flowcharts) · [performance-audit-playbook](https://alp78.github.io/elysium/04-Databases/01-SQL-Server/01-Server-Operations/16-performance-audit-playbook) · [keys-defaults-identity-and-sequences](https://alp78.github.io/elysium/04-Databases/01-SQL-Server/02-Database-Design-and-Storage/04-keys-defaults-identity-and-sequences) · [execution-plans](https://alp78.github.io/elysium/04-Databases/01-SQL-Server/03-Query-Writing-and-Optimization/13-execution-plans) · [wait-stats-analysis](https://alp78.github.io/elysium/04-Databases/01-SQL-Server/03-Query-Writing-and-Optimization/14-wait-stats-analysis) · [system-functions-and-session-metadata](https://alp78.github.io/elysium/04-Databases/01-SQL-Server/03-Query-Writing-and-Optimization/15-system-functions-and-session-metadata) · [blocking-and-locking](https://alp78.github.io/elysium/04-Databases/01-SQL-Server/03-Query-Writing-and-Optimization/16-blocking-and-locking)
...
**Scope:** server-wide · **Permissions:** VIEW SERVER STATE · **Resets:** instance restart
**Used in:** [sqlcmd-connection-and-usage](https://alp78.github.io/elysium/04-Databases/01-SQL-Server/01-Server-Operations/02-sqlcmd-connection-and-usage) · [sql-server-authentication](https://alp78.github.io/elysium/04-Databases/01-SQL-Server/01-Server-Operations/03-sql-server-authentication) · [essential-dba-queries](https://alp78.github.io/elysium/04-Databases/01-SQL-Server/01-Server-Operations/06-essential-dba-queries) · [memory-and-buffer-pool](https://alp78.github.io/elysium/04-Databases/01-SQL-Server/01-Server-Operations/11-memory-and-buffer-pool) · [performance-audit-playbook](https://alp78.github.io/elysium/04-Databases/01-SQL-Server/01-Server-Operations/16-performance-audit-playbook) · [index-types-and-strategy](https://alp78.github.io/elysium/04-Databases/01-SQL-Server/02-Database-Design-and-Storage/06-index-types-and-strategy) · [execution-plans](https://alp78.github.io/elysium/04-Databases/01-SQL-Server/03-Query-Writing-and-Optimization/13-execution-plans) · [system-functions-and-session-metadata](https://alp78.github.io/elysium/04-Databases/01-SQL-Server/03-Query-Writing-and-Optimization/15-system-functions-and-session-metadata) · [blocking-and-locking](https://alp78.github.io/elysium/04-Databases/01-SQL-Server/03-Query-Writing-and-Optimization/16-blocking-and-locking) · [race-conditions](https://alp78.github.io/elysium/04-Databases/01-SQL-Server/03-Query-Writing-and-Optimization/18-race-conditions) · [pipeline-integration-and-devex](https://alp78.github.io/elysium/04-Databases/01-SQL-Server/04-Applied-SQL-Server-for-Data-Pipelines/07-pipeline-integration-and-devex)
...
**Used in:** [essential-dba-queries](https://alp78.github.io/elysium/04-Databases/01-SQL-Server/01-Server-Operations/06-essential-dba-queries) · [memory-and-buffer-pool](https://alp78.github.io/elysium/04-Databases/01-SQL-Server/01-Server-Operations/11-memory-and-buffer-pool) · [sql-server-problems](https://alp78.github.io/elysium/04-Databases/01-SQL-Server/01-Server-Operations/14-sql-server-problems) · [performance-audit-playbook](https://alp78.github.io/elysium/04-Databases/01-SQL-Server/01-Server-Operations/16-performance-audit-playbook) · [index-types-and-strategy](https://alp78.github.io/elysium/04-Databases/01-SQL-Server/02-Database-Design-and-Storage/06-index-types-and-strategy) · [execution-plans](https://alp78.github.io/elysium/04-Databases/01-SQL-Server/03-Query-Writing-and-Optimization/13-execution-plans)
...
**Used in:** [essential-dba-queries](https://alp78.github.io/elysium/04-Databases/01-SQL-Server/01-Server-Operations/06-essential-dba-queries) · [memory-and-buffer-pool](https://alp78.github.io/elysium/04-Databases/01-SQL-Server/01-Server-Operations/11-memory-and-buffer-pool) · [sql-server-problems](https://alp78.github.io/elysium/04-Databases/01-SQL-Server/01-Server-Operations/14-sql-server-problems) · [troubleshooting-flowcharts](https://alp78.github.io/elysium/04-Databases/01-SQL-Server/01-Server-Operations/15-troubleshooting-flowcharts) · [performance-audit-playbook](https://alp78.github.io/elysium/04-Databases/01-SQL-Server/01-Server-Operations/16-performance-audit-playbook) · [index-types-and-strategy](https://alp78.github.io/elysium/04-Databases/01-SQL-Server/02-Database-Design-and-Storage/06-index-types-and-strategy) · [system-functions-and-session-metadata](https://alp78.github.io/elysium/04-Databases/01-SQL-Server/03-Query-Writing-and-Optimization/15-system-functions-and-session-metadata) · [blocking-and-locking](https://alp78.github.io/elysium/04-Databases/01-SQL-Server/03-Query-Writing-and-Optimization/16-blocking-and-locking) · [pipeline-integration-and-devex](https://alp78.github.io/elysium/04-Databases/01-SQL-Server/04-Applied-SQL-Server-for-Data-Pipelines/07-pipeline-integration-and-devex)
...
**Used in:** [sql-server-problems](https://alp78.github.io/elysium/04-Databases/01-SQL-Server/01-Server-Operations/14-sql-server-problems) · [performance-audit-playbook](https://alp78.github.io/elysium/04-Databases/01-SQL-Server/01-Server-Operations/16-performance-audit-playbook) · [index-types-and-strategy](https://alp78.github.io/elysium/04-Databases/01-SQL-Server/02-Database-Design-and-Storage/06-index-types-and-strategy) · [execution-plans](https://alp78.github.io/elysium/04-Databases/01-SQL-Server/03-Query-Writing-and-Optimization/13-execution-plans)
...
**Used in:** [memory-and-buffer-pool](https://alp78.github.io/elysium/04-Databases/01-SQL-Server/01-Server-Operations/11-memory-and-buffer-pool) · [performance-audit-playbook](https://alp78.github.io/elysium/04-Databases/01-SQL-Server/01-Server-Operations/16-performance-audit-playbook) · [finops-cost-optimization](https://alp78.github.io/elysium/04-Databases/01-SQL-Server/01-Server-Operations/17-finops-cost-optimization) · [pipeline-integration-and-devex](https://alp78.github.io/elysium/04-Databases/01-SQL-Server/04-Applied-SQL-Server-for-Data-Pipelines/07-pipeline-integration-and-devex)
...
**Scope:** server-wide · **Permissions:** VIEW SERVER STATE
**Used in:** [memory-and-buffer-pool](https://alp78.github.io/elysium/04-Databases/01-SQL-Server/01-Server-Operations/11-memory-and-buffer-pool) · [performance-audit-playbook](https://alp78.github.io/elysium/04-Databases/01-SQL-Server/01-Server-Operations/16-performance-audit-playbook)
...
**Scope:** server-wide · **Permissions:** VIEW SERVER STATE · **Type:** table-valued function
**Used in:** [performance-audit-playbook](https://alp78.github.io/elysium/04-Databases/01-SQL-Server/01-Server-Operations/16-performance-audit-playbook)
...
**Scope:** server-wide · **Permissions:** VIEW SERVER STATE
**Used in:** [memory-and-buffer-pool](https://alp78.github.io/elysium/04-Databases/01-SQL-Server/01-Server-Operations/11-memory-and-buffer-pool)
...
**Scope:** server-wide · **Permissions:** VIEW SERVER STATE · **Type:** table-valued function
**Used in:** [execution-plans](https://alp78.github.io/elysium/04-Databases/01-SQL-Server/03-Query-Writing-and-Optimization/13-execution-plans)
...
**Used in:** [essential-dba-queries](https://alp78.github.io/elysium/04-Databases/01-SQL-Server/01-Server-Operations/06-essential-dba-queries) · [high-availability-overview](https://alp78.github.io/elysium/04-Databases/01-SQL-Server/01-Server-Operations/09-high-availability-overview) · [always-on-availability-groups](https://alp78.github.io/elysium/04-Databases/01-SQL-Server/01-Server-Operations/10-always-on-availability-groups) · [memory-and-buffer-pool](https://alp78.github.io/elysium/04-Databases/01-SQL-Server/01-Server-Operations/11-memory-and-buffer-pool) · [sql-server-problems](https://alp78.github.io/elysium/04-Databases/01-SQL-Server/01-Server-Operations/14-sql-server-problems) · [troubleshooting-flowcharts](https://alp78.github.io/elysium/04-Databases/01-SQL-Server/01-Server-Operations/15-troubleshooting-flowcharts) · [performance-audit-playbook](https://alp78.github.io/elysium/04-Databases/01-SQL-Server/01-Server-Operations/16-performance-audit-playbook) · [finops-cost-optimization](https://alp78.github.io/elysium/04-Databases/01-SQL-Server/01-Server-Operations/17-finops-cost-optimization) · [database-creation-and-file-layout](https://alp78.github.io/elysium/04-Databases/01-SQL-Server/02-Database-Design-and-Storage/01-database-creation-and-file-layout) · [execution-plans](https://alp78.github.io/elysium/04-Databases/01-SQL-Server/03-Query-Writing-and-Optimization/13-execution-plans) · [wait-stats-analysis](https://alp78.github.io/elysium/04-Databases/01-SQL-Server/03-Query-Writing-and-Optimization/14-wait-stats-analysis) · [blocking-and-locking](https://alp78.github.io/elysium/04-Databases/01-SQL-Server/03-Query-Writing-and-Optimization/16-blocking-and-locking)
...
**Scope:** server-wide · **Permissions:** VIEW SERVER STATE · **Resets:** instance restart
**Used in:** [server-configuration](https://alp78.github.io/elysium/04-Databases/01-SQL-Server/01-Server-Operations/01-server-configuration) · [essential-dba-queries](https://alp78.github.io/elysium/04-Databases/01-SQL-Server/01-Server-Operations/06-essential-dba-queries) · [memory-and-buffer-pool](https://alp78.github.io/elysium/04-Databases/01-SQL-Server/01-Server-Operations/11-memory-and-buffer-pool) · [performance-audit-playbook](https://alp78.github.io/elysium/04-Databases/01-SQL-Server/01-Server-Operations/16-performance-audit-playbook) · [finops-cost-optimization](https://alp78.github.io/elysium/04-Databases/01-SQL-Server/01-Server-Operations/17-finops-cost-optimization) · [index-maintenance](https://alp78.github.io/elysium/04-Databases/01-SQL-Server/02-Database-Design-and-Storage/07-index-maintenance) · [execution-plans](https://alp78.github.io/elysium/04-Databases/01-SQL-Server/03-Query-Writing-and-Optimization/13-execution-plans) · [wait-stats-analysis](https://alp78.github.io/elysium/04-Databases/01-SQL-Server/03-Query-Writing-and-Optimization/14-wait-stats-analysis) · [system-functions-and-session-metadata](https://alp78.github.io/elysium/04-Databases/01-SQL-Server/03-Query-Writing-and-Optimization/15-system-functions-and-session-metadata)
...
**Scope:** server-wide · **Permissions:** VIEW SERVER STATE
**Used in:** [memory-and-buffer-pool](https://alp78.github.io/elysium/04-Databases/01-SQL-Server/01-Server-Operations/11-memory-and-buffer-pool) · [performance-audit-playbook](https://alp78.github.io/elysium/04-Databases/01-SQL-Server/01-Server-Operations/16-performance-audit-playbook) · [wait-stats-analysis](https://alp78.github.io/elysium/04-Databases/01-SQL-Server/03-Query-Writing-and-Optimization/14-wait-stats-analysis) · [system-functions-and-session-metadata](https://alp78.github.io/elysium/04-Databases/01-SQL-Server/03-Query-Writing-and-Optimization/15-system-functions-and-session-metadata)
...
**Scope:** server-wide · **Permissions:** VIEW SERVER STATE
**Used in:** [memory-and-buffer-pool](https://alp78.github.io/elysium/04-Databases/01-SQL-Server/01-Server-Operations/11-memory-and-buffer-pool) · [finops-cost-optimization](https://alp78.github.io/elysium/04-Databases/01-SQL-Server/01-Server-Operations/17-finops-cost-optimization)
...
**Used in:** [troubleshooting-flowcharts](https://alp78.github.io/elysium/04-Databases/01-SQL-Server/01-Server-Operations/15-troubleshooting-flowcharts) · [finops-cost-optimization](https://alp78.github.io/elysium/04-Databases/01-SQL-Server/01-Server-Operations/17-finops-cost-optimization) · [wait-stats-analysis](https://alp78.github.io/elysium/04-Databases/01-SQL-Server/03-Query-Writing-and-Optimization/14-wait-stats-analysis)
...
**Scope:** server-wide · **Permissions:** VIEW SERVER STATE
**Used in:** [system-functions-and-session-metadata](https://alp78.github.io/elysium/04-Databases/01-SQL-Server/03-Query-Writing-and-Optimization/15-system-functions-and-session-metadata)
...
**Used in:** [essential-dba-queries](https://alp78.github.io/elysium/04-Databases/01-SQL-Server/01-Server-Operations/06-essential-dba-queries) · [sql-server-problems](https://alp78.github.io/elysium/04-Databases/01-SQL-Server/01-Server-Operations/14-sql-server-problems) · [performance-audit-playbook](https://alp78.github.io/elysium/04-Databases/01-SQL-Server/01-Server-Operations/16-performance-audit-playbook) · [database-creation-and-file-layout](https://alp78.github.io/elysium/04-Databases/01-SQL-Server/02-Database-Design-and-Storage/01-database-creation-and-file-layout) · [storage-internals](https://alp78.github.io/elysium/04-Databases/01-SQL-Server/02-Database-Design-and-Storage/02-storage-internals) · [schemas-tables-and-constraints](https://alp78.github.io/elysium/04-Databases/01-SQL-Server/02-Database-Design-and-Storage/03-schemas-tables-and-constraints) · [keys-defaults-identity-and-sequences](https://alp78.github.io/elysium/04-Databases/01-SQL-Server/02-Database-Design-and-Storage/04-keys-defaults-identity-and-sequences) · [index-types-and-strategy](https://alp78.github.io/elysium/04-Databases/01-SQL-Server/02-Database-Design-and-Storage/06-index-types-and-strategy) · [index-maintenance](https://alp78.github.io/elysium/04-Databases/01-SQL-Server/02-Database-Design-and-Storage/07-index-maintenance)
...
**Used in:** [troubleshooting-flowcharts](https://alp78.github.io/elysium/04-Databases/01-SQL-Server/01-Server-Operations/15-troubleshooting-flowcharts) · [storage-internals](https://alp78.github.io/elysium/04-Databases/01-SQL-Server/02-Database-Design-and-Storage/02-storage-internals) · [index-types-and-strategy](https://alp78.github.io/elysium/04-Databases/01-SQL-Server/02-Database-Design-and-Storage/06-index-types-and-strategy) · [index-maintenance](https://alp78.github.io/elysium/04-Databases/01-SQL-Server/02-Database-Design-and-Storage/07-index-maintenance) · [table-compression](https://alp78.github.io/elysium/04-Databases/01-SQL-Server/02-Database-Design-and-Storage/08-table-compression) · [blocking-and-locking](https://alp78.github.io/elysium/04-Databases/01-SQL-Server/03-Query-Writing-and-Optimization/16-blocking-and-locking)
...
**Used in:** [troubleshooting-flowcharts](https://alp78.github.io/elysium/04-Databases/01-SQL-Server/01-Server-Operations/15-troubleshooting-flowcharts) · [finops-cost-optimization](https://alp78.github.io/elysium/04-Databases/01-SQL-Server/01-Server-Operations/17-finops-cost-optimization) · [index-types-and-strategy](https://alp78.github.io/elysium/04-Databases/01-SQL-Server/02-Database-Design-and-Storage/06-index-types-and-strategy) · [index-maintenance](https://alp78.github.io/elysium/04-Databases/01-SQL-Server/02-Database-Design-and-Storage/07-index-maintenance) · [json-xml-and-semi-structured-data](https://alp78.github.io/elysium/04-Databases/01-SQL-Server/03-Query-Writing-and-Optimization/09-json-xml-and-semi-structured-data) · [merge-and-upsert](https://alp78.github.io/elysium/04-Databases/01-SQL-Server/03-Query-Writing-and-Optimization/11-merge-and-upsert) · [sargable-queries](https://alp78.github.io/elysium/04-Databases/01-SQL-Server/03-Query-Writing-and-Optimization/12-sargable-queries) · [system-functions-and-session-metadata](https://alp78.github.io/elysium/04-Databases/01-SQL-Server/03-Query-Writing-and-Optimization/15-system-functions-and-session-metadata)
...
**Scope:** server-wide · **Permissions:** VIEW SERVER STATE · **Resets:** instance restart
**Used in:** [essential-dba-queries](https://alp78.github.io/elysium/04-Databases/01-SQL-Server/01-Server-Operations/06-essential-dba-queries) · [troubleshooting-flowcharts](https://alp78.github.io/elysium/04-Databases/01-SQL-Server/01-Server-Operations/15-troubleshooting-flowcharts) · [index-types-and-strategy](https://alp78.github.io/elysium/04-Databases/01-SQL-Server/02-Database-Design-and-Storage/06-index-types-and-strategy) · [index-maintenance](https://alp78.github.io/elysium/04-Databases/01-SQL-Server/02-Database-Design-and-Storage/07-index-maintenance) · [execution-plans](https://alp78.github.io/elysium/04-Databases/01-SQL-Server/03-Query-Writing-and-Optimization/13-execution-plans)
...
**Scope:** server-wide · **Permissions:** VIEW SERVER STATE · **Resets:** instance restart
**Used in:** [essential-dba-queries](https://alp78.github.io/elysium/04-Databases/01-SQL-Server/01-Server-Operations/06-essential-dba-queries) · [troubleshooting-flowcharts](https://alp78.github.io/elysium/04-Databases/01-SQL-Server/01-Server-Operations/15-troubleshooting-flowcharts) · [index-types-and-strategy](https://alp78.github.io/elysium/04-Databases/01-SQL-Server/02-Database-Design-and-Storage/06-index-types-and-strategy) · [index-maintenance](https://alp78.github.io/elysium/04-Databases/01-SQL-Server/02-Database-Design-and-Storage/07-index-maintenance)
...
**Used in:** [essential-dba-queries](https://alp78.github.io/elysium/04-Databases/01-SQL-Server/01-Server-Operations/06-essential-dba-queries) · [sql-server-problems](https://alp78.github.io/elysium/04-Databases/01-SQL-Server/01-Server-Operations/14-sql-server-problems) · [finops-cost-optimization](https://alp78.github.io/elysium/04-Databases/01-SQL-Server/01-Server-Operations/17-finops-cost-optimization) · [database-creation-and-file-layout](https://alp78.github.io/elysium/04-Databases/01-SQL-Server/02-Database-Design-and-Storage/01-database-creation-and-file-layout) · [storage-internals](https://alp78.github.io/elysium/04-Databases/01-SQL-Server/02-Database-Design-and-Storage/02-storage-internals) · [schemas-tables-and-constraints](https://alp78.github.io/elysium/04-Databases/01-SQL-Server/02-Database-Design-and-Storage/03-schemas-tables-and-constraints)
...
**Scope:** current database · **Permissions:** VIEW DATABASE STATE
**Used in:** [restore-and-recovery](https://alp78.github.io/elysium/04-Databases/01-SQL-Server/01-Server-Operations/08-restore-and-recovery) · [performance-audit-playbook](https://alp78.github.io/elysium/04-Databases/01-SQL-Server/01-Server-Operations/16-performance-audit-playbook) · [finops-cost-optimization](https://alp78.github.io/elysium/04-Databases/01-SQL-Server/01-Server-Operations/17-finops-cost-optimization) · [database-creation-and-file-layout](https://alp78.github.io/elysium/04-Databases/01-SQL-Server/02-Database-Design-and-Storage/01-database-creation-and-file-layout) · [storage-internals](https://alp78.github.io/elysium/04-Databases/01-SQL-Server/02-Database-Design-and-Storage/02-storage-internals)
...
**Scope:** current database · **Permissions:** VIEW DATABASE STATE
**Used in:** [troubleshooting-flowcharts](https://alp78.github.io/elysium/04-Databases/01-SQL-Server/01-Server-Operations/15-troubleshooting-flowcharts) · [performance-audit-playbook](https://alp78.github.io/elysium/04-Databases/01-SQL-Server/01-Server-Operations/16-performance-audit-playbook) · [storage-internals](https://alp78.github.io/elysium/04-Databases/01-SQL-Server/02-Database-Design-and-Storage/02-storage-internals)
...
**Used in:** [storage-internals](https://alp78.github.io/elysium/04-Databases/01-SQL-Server/02-Database-Design-and-Storage/02-storage-internals)
...
**Scope:** current database · **Permissions:** VIEW DATABASE STATE
**Used in:** [essential-dba-queries](https://alp78.github.io/elysium/04-Databases/01-SQL-Server/01-Server-Operations/06-essential-dba-queries) · [table-compression](https://alp78.github.io/elysium/04-Databases/01-SQL-Server/02-Database-Design-and-Storage/08-table-compression) · [partitioning-strategies](https://alp78.github.io/elysium/04-Databases/01-SQL-Server/02-Database-Design-and-Storage/09-partitioning-strategies)
...
**Scope:** database · **Permissions:** VIEW DATABASE STATE · **Type:** table-valued function
**Used in:** [sql-server-problems](https://alp78.github.io/elysium/04-Databases/01-SQL-Server/01-Server-Operations/14-sql-server-problems) · [performance-audit-playbook](https://alp78.github.io/elysium/04-Databases/01-SQL-Server/01-Server-Operations/16-performance-audit-playbook) · [index-maintenance](https://alp78.github.io/elysium/04-Databases/01-SQL-Server/02-Database-Design-and-Storage/07-index-maintenance)
...
**Scope:** current database · **Permissions:** VIEW DATABASE STATE
**Used in:** [performance-audit-playbook](https://alp78.github.io/elysium/04-Databases/01-SQL-Server/01-Server-Operations/16-performance-audit-playbook) · [schemas-tables-and-constraints](https://alp78.github.io/elysium/04-Databases/01-SQL-Server/02-Database-Design-and-Storage/03-schemas-tables-and-constraints) · [index-types-and-strategy](https://alp78.github.io/elysium/04-Databases/01-SQL-Server/02-Database-Design-and-Storage/06-index-types-and-strategy) · [index-maintenance](https://alp78.github.io/elysium/04-Databases/01-SQL-Server/02-Database-Design-and-Storage/07-index-maintenance)
...
**Scope:** current database · **Permissions:** VIEW DATABASE STATE
**Used in:** [finops-cost-optimization](https://alp78.github.io/elysium/04-Databases/01-SQL-Server/01-Server-Operations/17-finops-cost-optimization)
...
**Scope:** current database · **Permissions:** VIEW DATABASE STATE
**Used in:** [schemas-tables-and-constraints](https://alp78.github.io/elysium/04-Databases/01-SQL-Server/02-Database-Design-and-Storage/03-schemas-tables-and-constraints)
...
**Scope:** server-wide · **Permissions:** VIEW SERVER STATE
**Used in:** [essential-dba-queries](https://alp78.github.io/elysium/04-Databases/01-SQL-Server/01-Server-Operations/06-essential-dba-queries) · [backup-types-and-strategy](https://alp78.github.io/elysium/04-Databases/01-SQL-Server/01-Server-Operations/07-backup-types-and-strategy) · [sql-server-problems](https://alp78.github.io/elysium/04-Databases/01-SQL-Server/01-Server-Operations/14-sql-server-problems) · [performance-audit-playbook](https://alp78.github.io/elysium/04-Databases/01-SQL-Server/01-Server-Operations/16-performance-audit-playbook) · [system-functions-and-session-metadata](https://alp78.github.io/elysium/04-Databases/01-SQL-Server/03-Query-Writing-and-Optimization/15-system-functions-and-session-metadata)
...
**Scope:** server-wide · **Permissions:** VIEW SERVER STATE
**Used in:** [essential-dba-queries](https://alp78.github.io/elysium/04-Databases/01-SQL-Server/01-Server-Operations/06-essential-dba-queries) · [sql-server-problems](https://alp78.github.io/elysium/04-Databases/01-SQL-Server/01-Server-Operations/14-sql-server-problems) · [system-functions-and-session-metadata](https://alp78.github.io/elysium/04-Databases/01-SQL-Server/03-Query-Writing-and-Optimization/15-system-functions-and-session-metadata)
...
**Scope:** server-wide · **Permissions:** VIEW SERVER STATE
**Used in:** [essential-dba-queries](https://alp78.github.io/elysium/04-Databases/01-SQL-Server/01-Server-Operations/06-essential-dba-queries) · [performance-audit-playbook](https://alp78.github.io/elysium/04-Databases/01-SQL-Server/01-Server-Operations/16-performance-audit-playbook)
...
**Scope:** server-wide · **Permissions:** VIEW SERVER STATE
**Used in:** [sql-server-problems](https://alp78.github.io/elysium/04-Databases/01-SQL-Server/01-Server-Operations/14-sql-server-problems) · [performance-audit-playbook](https://alp78.github.io/elysium/04-Databases/01-SQL-Server/01-Server-Operations/16-performance-audit-playbook) · [database-creation-and-file-layout](https://alp78.github.io/elysium/04-Databases/01-SQL-Server/02-Database-Design-and-Storage/01-database-creation-and-file-layout)
...
**Scope:** server-wide · **Permissions:** VIEW SERVER STATE
**Used in:** [high-availability-overview](https://alp78.github.io/elysium/04-Databases/01-SQL-Server/01-Server-Operations/09-high-availability-overview) · [always-on-availability-groups](https://alp78.github.io/elysium/04-Databases/01-SQL-Server/01-Server-Operations/10-always-on-availability-groups) · [sql-server-problems](https://alp78.github.io/elysium/04-Databases/01-SQL-Server/01-Server-Operations/14-sql-server-problems) · [troubleshooting-flowcharts](https://alp78.github.io/elysium/04-Databases/01-SQL-Server/01-Server-Operations/15-troubleshooting-flowcharts)
...
**Scope:** server-wide · **Permissions:** VIEW SERVER STATE
**Used in:** [high-availability-overview](https://alp78.github.io/elysium/04-Databases/01-SQL-Server/01-Server-Operations/09-high-availability-overview) · [always-on-availability-groups](https://alp78.github.io/elysium/04-Databases/01-SQL-Server/01-Server-Operations/10-always-on-availability-groups)
...
**Scope:** server-wide · **Permissions:** VIEW SERVER STATE
**Used in:** [high-availability-overview](https://alp78.github.io/elysium/04-Databases/01-SQL-Server/01-Server-Operations/09-high-availability-overview)
...
**Scope:** server-wide · **Permissions:** VIEW SERVER STATE
**Used in:** [sql-server-problems](https://alp78.github.io/elysium/04-Databases/01-SQL-Server/01-Server-Operations/14-sql-server-problems) · [troubleshooting-flowcharts](https://alp78.github.io/elysium/04-Databases/01-SQL-Server/01-Server-Operations/15-troubleshooting-flowcharts) · [performance-audit-playbook](https://alp78.github.io/elysium/04-Databases/01-SQL-Server/01-Server-Operations/16-performance-audit-playbook) · [deadlock-detection-and-prevention](https://alp78.github.io/elysium/04-Databases/01-SQL-Server/03-Query-Writing-and-Optimization/17-deadlock-detection-and-prevention)
...
**Scope:** server-wide · **Permissions:** VIEW SERVER STATE
**Used in:** [audit-logging](https://alp78.github.io/elysium/04-Databases/01-SQL-Server/01-Server-Operations/12-audit-logging)
...
**Scope:** server-wide · **Permissions:** VIEW SERVER STATE
**Used in:** [tde-encryption](https://alp78.github.io/elysium/04-Databases/01-SQL-Server/01-Server-Operations/13-tde-encryption) · [sql-server-problems](https://alp78.github.io/elysium/04-Databases/01-SQL-Server/01-Server-Operations/14-sql-server-problems)
...
**Scope:** server-wide · **Permissions:** VIEW SERVER STATE
**Used in:** [database-creation-and-file-layout](https://alp78.github.io/elysium/04-Databases/01-SQL-Server/02-Database-Design-and-Storage/01-database-creation-and-file-layout)
...
**Scope:** server-wide · **Permissions:** VIEW SERVER STATE
**Used in:** [sql-server-change-tracking](https://alp78.github.io/elysium/04-Databases/01-SQL-Server/02-Database-Design-and-Storage/10-sql-server-change-tracking)
...
**Used in:** [sql-server-authentication](https://alp78.github.io/elysium/04-Databases/01-SQL-Server/01-Server-Operations/03-sql-server-authentication) · [audit-logging](https://alp78.github.io/elysium/04-Databases/01-SQL-Server/01-Server-Operations/12-audit-logging)
...
**Used in:** [users-logins-roles-permissions](https://alp78.github.io/elysium/04-Databases/01-SQL-Server/01-Server-Operations/04-users-logins-roles-permissions)
...
**Scope:** server-wide · **Permissions:** PUBLIC · **Type:** table-valued function
**Used in:** [data-types-conversion-and-null-handling](https://alp78.github.io/elysium/04-Databases/01-SQL-Server/03-Query-Writing-and-Optimization/02-data-types-conversion-and-null-handling)
