...
See [SQL Server | server configuration](https://alp78.github.io/elysium/04-Databases/01-SQL-Server/01-Server-Operations/01-server-configuration) for the remediation patterns behind each setting.
