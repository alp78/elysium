...
> [!tip] Prerequisites
>
> Before writing delete logic in scripts, enable [set -euo pipefail](https://alp78.github.io/elysium/01-Shell/Scripting/defensive-scripting) -- `set -u` prevents the catastrophic `rm -rf $UNDEFINED` expansion, and `trap EXIT` ensures cleanup runs even on error.
...
> [brace expansion](https://alp78.github.io/elysium/01-Shell/Scripting/brace-expansion-and-globbing), a single command creates an entire
> [medallion-architecture](https://alp78.github.io/elysium/14-Data-Architecture/Pipeline-Patterns/medallion-architecture) directory tree.
...
> [navigation-and-listing](https://alp78.github.io/elysium/01-Shell/File-Operations/navigation-and-listing).
