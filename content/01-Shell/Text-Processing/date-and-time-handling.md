...
tags: [concept, python, sql-server, csharp, bash, powershell, data-formats, etl, reference]
...
related: [json-and-csv-processing, serialization-formats, sql-python-csharp-transforms, idempotent-pipeline-design, etl-vs-elt]
created: 2026-03-22
updated: 2026-03-22
status: complete
---
