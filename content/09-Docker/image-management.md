...
Docker images are the immutable, layered artifacts that run as [[container-lifecycle|containers]]. For data engineering pipelines, you build images locally or in [[github-actions-workflows|CI/CD]], push them to [[terraform-registry-and-ci|Artifact Registry]], and deploy to [[cloud-run-jobs-vs-services|Cloud Run]] or the Airflow DAGs. Understanding how images are built, layered, and sized is essential for fast deploys and low costs.
...
- [[container-lifecycle]] — Running containers from images (create, start, exec, logs, stop)
...
- [[github-actions-workflows]] — CI/CD pipelines that build and push images automatically
- [[terraform-registry-and-ci]] — Artifact Registry Terraform configuration and Cloud Run job definitions
- [[cloud-run-jobs-vs-services]] — Where images are deployed and how cold start time relates to image size
